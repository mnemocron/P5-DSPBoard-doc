\subsubsection{Ressourcenbedarf und Timing der CMSIS/DSP Funktionen}
...
Theoretisch wird erwartet, dass die FPU des Cortex-M4 Cores ein FIR Filter mit der Effizienz von $1\frac{cycle}{TAP}$ mit Hilfe des Multiply-Accumulate Befehls (\texttt{MAC})) berechnet. Die folgende Messung soll das tatsächliche Ergebnis liefern.
...
Gemäss den Zahlen im Whitepaper kann mit einer Taktfrequenz von $f_{CPU}=100\si{kHz}$
